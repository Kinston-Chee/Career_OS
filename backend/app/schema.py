...
class CandidateStatus(str, Enum):
    university_student = 'university_student'   # currently enrolled
    fresh_graduate     = 'fresh_graduate'        # graduated ≤ 2 yrs, no full-time experience
    early_career       = 'early_career'          # 1–5 yrs experience
    experienced        = 'experienced'           # 5+ yrs
    career_changer     = 'career_changer'        # pivoting industries/roles
