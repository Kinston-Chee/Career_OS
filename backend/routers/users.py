...
from app.schema import PostResponse, UserCreate, UserPrivate, UserPublic, UserUpdate, Token,UserRole
...
async def create_user(user: UserCreate, db: Annotated[AsyncSession, Depends(get_db)]):
    ...
    #         new_candidate = models.Candidate(user_id = new_user.id)
    #     case UserRole.university:
    #         new_university_user = models.Candidate(user_id = new_user.id)
