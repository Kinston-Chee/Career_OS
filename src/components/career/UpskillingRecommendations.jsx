...
const RECOMMENDATIONS = [
  { type: 'Workshop', title: 'Power BI Dashboard Masterclass', provider: 'Microsoft Learn', skill: 'Power BI', icon: '🏫', match: 94 },
  { type: 'Certification', title: 'Google Data Analytics Certificate', provider: 'Coursera', skill: 'Data Analysis', icon: '🎓', match: 91 },
  { type: 'Workshop', title: 'Advanced SQL for Analytics', provider: 'DataCamp', skill: 'SQL', icon: '🏫', match: 89 },
  { type: 'Certification', title: 'Tableau Desktop Specialist', provider: 'Salesforce', skill: 'Tableau', icon: '🎓', match: 85 },
  { type: 'Event', title: 'Data Science Meetup KL', provider: 'Community', skill: 'Networking', icon: '🤝', match: 78 },
  { type: 'Workshop', title: 'Statistics for Data Science', provider: 'Khan Academy', skill: 'Statistics', icon: '📐', match: 82 },
]
