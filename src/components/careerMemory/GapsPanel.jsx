  ...
  return (
    <section className="rounded-xl border border-[#e2eaf8] bg-white p-5 shadow-[0_8px_22px_rgba(44,76,142,0.07)]">
      ...
      <div className="space-y-3.5">
        {gaps.map((gap) => (
          <div key={gap.id} className="flex items-start gap-2.5">
            <AlertTriangle size={15} className="mt-0.5 flex-shrink-0 text-orange-500" strokeWidth={2.2} />
            <p className="flex-1 text-sm font-medium leading-snug text-[#4d5c7d]">{gap.text}</p>
