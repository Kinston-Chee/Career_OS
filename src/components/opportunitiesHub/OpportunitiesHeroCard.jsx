...
import robotImage from '../../assets/robot-2.png'
...
export default function OpportunitiesHeroCard({ headline, picks, onWhyClick, onViewDetails }) {
      ...
      <div className="relative grid grid-cols-1 gap-5 px-5 py-6 sm:px-8 lg:grid-cols-[minmax(330px,0.9fr)_minmax(0,1.55fr)]">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
          {showRecommendations && picks.map((pick, index) => (
            <article
              key={pick.id}
              className="flex min-h-[172px] flex-col rounded-xl border border-white/70 bg-white/62 p-4 shadow-[0_12px_30px_rgba(39,75,143,0.12)] backdrop-blur-xl transition duration-200 hover:-translate-y-0.5 hover:bg-white/78"
            ...
            >
              ...
              <button
                ...
                className="mt-auto inline-flex items-center gap-1 text-xs font-semibold text-blue-600 hover:text-blue-700"
              >
