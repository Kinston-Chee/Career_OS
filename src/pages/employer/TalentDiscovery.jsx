...
function ShortlistRow({ rank, candidate, status, accent, onShortlist, onPass, onDraft, onView }) {
  ...
  return (
    <div
      ...
      className="relative grid cursor-pointer grid-cols-[28px_36px_1fr_auto] items-start gap-x-3 overflow-hidden rounded-xl border border-[#E4E7EC] bg-white px-4 py-3.5 transition hover:border-[#C8CDD6] hover:shadow-[0_2px_10px_rgba(15,17,32,.05)] focus:outline-none focus:ring-2 focus:ring-[#4F62F7] focus:ring-offset-2"
    >
